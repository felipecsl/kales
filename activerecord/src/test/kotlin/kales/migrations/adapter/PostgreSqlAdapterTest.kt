...
import kales.migrations.StubConnection
...
class PostgresAdapterTest {
  private val buildColumnDeclarationFunctionForTest =
      PostgresAdapter.Companion::class.java.getDeclaredMethod(
  ...
  fun testAddColumnForInteger() {
    ...
    val adapter = PostgresAdapter(connection)
  ...
  fun testRenameColumn() {
    val connection = StubConnection()
    val adapter: DbAdapter = PostgresAdapter(connection)
