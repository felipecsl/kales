...
import kales.migrations.adapter.DbAdapter
import kales.migrations.adapter.MySqlAdapter
import kales.migrations.adapter.PostgresAdapter
import kales.migrations.adapter.SqliteAdapter
...
abstract class AbstractMigration {
  internal lateinit var connection: ActiveRecordConnection
  ...
  private val adapter: DbAdapter by lazy {
    when (connection.config.dbms) {
      ...
      else -> PostgresAdapter(connection)
    }
  }
